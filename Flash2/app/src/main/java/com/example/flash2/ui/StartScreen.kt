...
import com.example.flash2.data.DataSource
...
fun CategoryCard(
    ...
    Card(modifier=Modifier.clickable {
        ...
        Toast.makeText(context, "This cart was clicked", Toast.LENGTH_SHORT).show()
...

        {
            ...
            Image(
                ...
                modifier = Modifier.size(105.dp) // Correct syntax
            )
        }
    }
}